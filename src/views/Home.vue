        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 La unidad aborda la enseñanza del arte, el juego y la recreación en la educación infantil como herramientas clave para el desarrollo integral. Se exploran estrategias pedagógicas para fomentar la creatividad, la interacción y el disfrute en el aprendizaje. Se presentan propuestas didácticas centradas en el arte, como la dactilopintura y el modelado; en el juego, incluyendo el juego simbólico y sensorial; y en la recreación, con circuitos lúdicos y juegos musicales. Se destaca la importancia de adaptar estas metodologías a los contextos educativos, promoviendo la participación activa de los niños.
